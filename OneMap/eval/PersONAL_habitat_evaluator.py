...
class HabitatEvaluator:
    ...
    def load_scene(self, scene_id: str):
        ...
        self.scene_data = PersONAL_Dataset.load_hm3d_objects(self.scene_data, self.sim.semantic_scene.objects, scene_id)
    ...
    def evaluate(self):
        ...
        for n_ep, episode in enumerate(self.episodes):
            ...
            #Skip episode if already evaluated (results exist in dir)
            ...
            #TODO: Need to consider multiple goal instances
            #PersONAL : Get category and instance info
            ...
            while steps < self.max_steps and current_obj_id < len(episode.obj_sequence):
                ...
                if called_found:
                    ...
                    #PersONAL : Obtain the locations of the specific object instance
                ...
                if steps % 100 == 0:
                    ...
                    #PersONAL : Calculates distance to target object instance (goal)
                    obj_locs = self.scene_data[episode.scene_id].object_locations[curr_obj_cat]
                    obj_locs = [obj for obj in obj_locs if obj.object_id == curr_obj_instance]
            ...
            save_path = f"{self.results_path}/trajectories/poses_{episode.episode_id}.csv"
